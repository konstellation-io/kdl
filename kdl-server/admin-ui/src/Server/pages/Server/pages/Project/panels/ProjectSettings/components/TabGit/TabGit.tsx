import RepositoryTypeComponent, {
  LOCATION,
  SIZE,
} from 'Server/pages/NewProject/pages/Repository/components/RepositoryTypeComponent/RepositoryTypeComponent';
import usePanel, { PanelType } from 'Server/apollo/hooks/usePanel';

import { Button } from 'kwc';
import CopyToClipboard from 'Components/CopyToClipboard/CopyToClipboard';
import { GetProjects_projects_repository } from 'Graphql/queries/types/GetProjects';
import IconEdit from '@material-ui/icons/Edit';
import { PANEL_ID } from 'Server/apollo/models/Panel';
